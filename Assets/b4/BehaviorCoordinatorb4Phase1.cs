...
public class BehaviorCoordinatorb4Phase1 : MonoBehaviour
{
    //stores
    ...
    //people behinds
    public Transform person1Behind;
    public Transform person2Behind;
    public Transform person3Behind;
    public Transform person4Behind;
    public Transform person5Behind;
    public Transform person6Behind;
    public Transform person7Behind;
    public Transform person8Behind;
    public Transform person9Behind;
    public Transform person10Behind;
    public Transform sales1Behind;
    public Transform sales2Behind;
    public Transform sales3Behind;
    public Transform sales4Behind;
    public Transform sales5Behind;
    public Transform sales6Behind;
    ...
    void Start()
    {
        ...
        robber.GetComponent<UnitySteeringController>().maxSpeed = 4;
    }
    ...
    public Node runAwayAsEveryoneStares()
    {
        ...
        Val<float> factorSpeed = Val.V(() => 5f);
    ...
    {
        Val<GameObject> pers1 = Val.V(() => person1);
        Val<GameObject> pers2 = Val.V(() => person2);
        Val<GameObject> pers3 = Val.V(() => person3);
        Val<GameObject> pers4 = Val.V(() => person4);
        Val<GameObject> pers5 = Val.V(() => person5);
        Val<GameObject> pers6 = Val.V(() => person6);
        Val<GameObject> pers7 = Val.V(() => person7);
        Val<GameObject> pers8 = Val.V(() => person8);
        Val<GameObject> pers9 = Val.V(() => person9);
        Val<GameObject> pers10 = Val.V(() => person10);
        Val<GameObject> sal1 = Val.V(() => sales1);
        Val<GameObject> sal2 = Val.V(() => sales2);
        Val<GameObject> sal3 = Val.V(() => sales3);
        Val<GameObject> sal4 = Val.V(() => sales4);
        Val<GameObject> sal5 = Val.V(() => sales5);
        Val<GameObject> sal6 = Val.V(() => sales6);
        ...
        return (new SequenceParallel(
            ...
            //robber approaches a random guy
            (new DecoratorLoop
                (new Selector(
                    (new Sequence(
                        ...
                        (new SelectorShuffle(
                            new Sequence((this.ST_Approach(person1Behind, robber)),(robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r, pers1, dir, t))),
                            new Sequence((this.ST_Approach(person2Behind, robber)),  (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,pers2, dir, t))),
                            new Sequence((this.ST_Approach(person3Behind, robber)),  (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,pers3, dir, t))),
                            new Sequence((this.ST_Approach(person4Behind, robber)), (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,pers4, dir, t))),
                            new Sequence((this.ST_Approach(person5Behind, robber)), (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,pers5, dir, t))),
                            new Sequence((this.ST_Approach(person6Behind, robber)), (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,pers6, dir, t))),
                            new Sequence((this.ST_Approach(person7Behind, robber)),  (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,pers7, dir, t))),
                            new Sequence((this.ST_Approach(person8Behind, robber)), (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,pers8, dir, t))),
                            new Sequence((this.ST_Approach(person9Behind, robber)), (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,pers9, dir, t))),
                            new Sequence((this.ST_Approach(person10Behind, robber)), (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,pers10, dir, t))),
                            new Sequence((this.ST_Approach(sales1Behind, robber)), (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,sal1, dir, t))),
                            new Sequence((this.ST_Approach(sales2Behind, robber)),  (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,sal2, dir, t))),
                            new Sequence((this.ST_Approach(sales3Behind, robber)), (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,sal3, dir, t))),
                            new Sequence((this.ST_Approach(sales4Behind, robber)), (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,sal4, dir, t))),
                            new Sequence((this.ST_Approach(sales5Behind, robber)),  (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,sal5, dir, t))),
                            new Sequence((this.ST_Approach(sales6Behind, robber)),  (robber.GetComponent<BehaviorMecanim>().ST_stealFromGuy(r,sal6, dir, t)))
                        ))
                        ,
                        new Selector(policeman.GetComponent<BehaviorMecanim>().Node_Sees(p1, r, isActive, d, dForward), policeman2.GetComponent<BehaviorMecanim>().Node_Sees(p2, r, isActive, d, dForward))
                        ,
